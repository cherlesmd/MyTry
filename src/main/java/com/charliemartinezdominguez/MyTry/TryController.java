...
public class TryController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<List<Try>> getAllNear(@PathVariable("id") String id,
    ...
    @PostMapping("/{id}")
    public ResponseEntity<Try> newUserTry(@PathVariable("id") String id, @RequestParam("name") String name,
